...
Kirigami.FormLayout {
    ...
    property alias cfg_refreshInterval: refreshIntervalField.text
    ...
    // Hidden textfield backing refreshInterval alias for KQuickConfigModule
    QQC2.TextField {
    ...
    QQC2.ComboBox {
        ...
        currentIndex: {
            var val = refreshIntervalField.text || "60000";
        ...
        onActivated: {
            refreshIntervalField.text = currentValue;
        }
    }
